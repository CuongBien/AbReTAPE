# Baseline B2: DP-SGD (Differential Privacy SGD) cho Client trong Split Learning
import math
import torch
...
class DPSGDClientOptimizer:
    ...
    2. Cắt ngưỡng gradient (Gradient Clipping) với ngưỡng C.
    ...
    def step(self, x, grad_z):
        ...
        # Chế độ 2: Cắt gradient theo toàn bộ batch
